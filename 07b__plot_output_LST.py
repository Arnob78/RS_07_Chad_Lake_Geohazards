...
if __name__ == '__main__':
    # --- File Paths ---
    input_tiff_path = "/srv/AB_YU/RS_07_Chad_Lake_Geohazards/06b__apply_ml_te_to_lst_data_GPU/TE_LST_to_NDVI_GPU.tif"
    
    # The output folder is the same as the one generated by the previous script
    output_folder = "/srv/AB_YU/RS_07_Chad_Lake_Geohazards/06b__apply_ml_te_to_lst_data_GPU"
    output_plot_path = os.path.join(output_folder, "TE_LST_to_NDVI_GPU_with_coords.png")
